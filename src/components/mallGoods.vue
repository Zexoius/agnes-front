<template>
    <div class="good-item">
        <div style="">
            <div class="good-img">
                <!--<a target="_blank" :href="'http://localhost:8082/goodsDetail?productId='+msg.productId">-->
					<a @click="toGood(msg.productId)">                    
            ...
            <div class="good-price pr">
                <div class="ds pa">
                    ...
                    <a @click="toGood(msg.productId)">
                    <!--<a >-->
                    	<!--<router-link to="/goodsDetail"></router-link>-->
                        <el-button style="margin: 0 5px">查看详情</el-button>
                    </a>
                    <el-button type="primary" style="margin: 0 5px" @click="_addCart(msg.productId,msg.salePrice,msg.productName,msg.picUrl)"
                        >加入购物车</el-button>
                </div>
                <p>
                    <span style="font-size:14px">￥</span>{{Number(msg.salePrice).toFixed(2)}}</p>
            </div>
        </div>
    </div>
</template>
