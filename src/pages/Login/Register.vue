				...
				<div class="registered">
					...
					<div class="content" style="margin-top: 20px;">
						<ul class="common-form">
							<li class="username border-1p">
								<div style="margin-top: 40px;" class="input">
									<el-input type="text" v-model="registered.username" placeholder="账号" @keyup="registered.username=registered.username.replace(/[^\w\.\/]/ig,'')"/>
								</div>
							</li>
							<li>
								<div class="input">
									<el-input type="password" v-model="registered.password" placeholder="密码"/>
								</div>
							</li>
							<li>
								<div class="input">
									<el-input type="password" v-model="registered.password2" placeholder="重复密码"/>
								</div>
							</li>
						</ul>
						...
						<div style="margin-bottom: 30px;">
							<y-button :classStyle="registered.password&&registered.password2&&registered.username&&registxt==='注册'?'main-btn':'disabled-btn'" :text="registxt" style="margin: 0;width: 100%;height: 48px;font-size: 18px;line-height: 48px" @btnClick="regist">
							</y-button>
						</div>
						...
						<ul class="common-form pr">
							...
							<li style="text-align: center;line-height: 48px;margin-bottom: 0;font-size: 12px;color: #999;">
								<span>如果您已拥有 agens 账号，则可在此</span>
								<a href="javascript:;" style="margin: 0 5px" @click="toLogin">登录</a>
							</li>
						</ul>
					</div>
				</div>
